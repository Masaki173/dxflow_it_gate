...
@auth
         ...
         <form method="GET" action="{{ route('hardware.index') }}">
                <button type="submit"
                    ...
                    @forelse ($logs->where('can_handle', true) as $log)
                        <tr>
                            ...
                            <td class="px-4 py-2 border-r border-gray-300">
                                {{ \App\Models\Inquiry::HARDWARE_OPTIONS[$log->inquiry->hardware_option] ?? '不明' }}
                            </td>
                            ...
                            <td class="px-4 py-2 border-r border-gray-300">
                                ...
                                <p class="mt-1 text-gray-800 dark:text-gray-200">{{ $log->details }}</p>
                                 ...
                                 @endif
                                <form method="POST" action="{{ route('hardware.updateDetails', $log->id) }}">
                                    @csrf
                                    @method('PATCH')
